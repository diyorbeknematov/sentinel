...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.username || !form.password) {
      setError('Username va password kiritish shart')
      return
    }
    setLoading(true)
    try {
    ...
    >
      <div className="flex w-full max-w-3xl mx-6 rounded-2xl overflow-hidden border border-[#E2E8F0] bg-white shadow-xl">
        ...
        <div className="flex-1 bg-white flex flex-col justify-center px-10 py-12">
          ...
          <h1 className="text-2xl font-bold text-[#1E293B] mb-1">Xush kelibsiz 👋</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin"
                  className="w-full bg-[#F1F5F9] border border-[#E2E8F0] rounded-lg pl-10 pr-4 py-3 text-sm text-[#1E293B] font-mono placeholder-slate-400 outline-none focus:bg-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/20 transition"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-[#F1F5F9] border border-[#E2E8F0] rounded-lg pl-10 pr-12 py-3 text-sm text-[#1E293B] font-mono placeholder-slate-400 outline-none focus:bg-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/20 transition"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold text-sm hover:opacity-95 active:scale-[0.99] transition disabled:opacity-50 flex items-center justify-center gap-2 shadow-sm"
            >
              {loading && (
